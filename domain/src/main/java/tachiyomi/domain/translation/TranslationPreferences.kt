...
class TranslationPreferences(
    ...
    // Balanced temperature for creativity vs structure
    fun translationEngineTemperature() = preferenceStore.getString("translation_engine_temperature", "0.6")
    fun translationEngineTopK() = preferenceStore.getString("translation_engine_top_k", "30")
    ...
    // Default 8192 is good for large contexts
